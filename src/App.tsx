...
import UploadMedia from "./pages/MPPortal/UploadMedia";
import PressReleases from "./pages/MPPortal/PressReleases";
import AddPressRelease from "./pages/MPPortal/AddPressRelease";
import PerformanceAnalytics from "./pages/MPPortal/PerformanceAnalytics";
import EngagementStatistics from "./pages/MPPortal/EngagementStatistics";

import CalendarEvents from "./pages/MPPortal/CalendarEvents";
import AddEvent from "./pages/MPPortal/AddEvent";
import GeneralSettings from "./pages/MPPortal/GeneralSettings";
import ChangePassword from "./pages/MPPortal/ChangePassword";
import NotificationPreferences from "./pages/MPPortal/NotificationPreferences";
import PrivacyVisibility from "./pages/MPPortal/PrivacyVisibility";
import NotificationCentre from "./pages/MPPortal/NotificationCentre";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/mp-portal" element={<MPPortalLayout />}>
          ...
          <Route path="media/press/new" element={<AddPressRelease />} />
          <Route path="analytics" element={<PerformanceAnalytics />} />
          <Route path="analytics/engagement" element={<EngagementStatistics />} />
          <Route path="calendar" element={<CalendarEvents />} />
          <Route path="calendar/new" element={<AddEvent />} />
          <Route path="settings" element={<GeneralSettings />} />
          <Route path="settings/password" element={<ChangePassword />} />
          <Route path="settings/notifications" element={<NotificationPreferences />} />
          <Route path="settings/privacy" element={<PrivacyVisibility />} />
