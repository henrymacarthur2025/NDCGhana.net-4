...
const FEATURED_MP = {
  ...
  approvalRating: 88,
  bio: "A dedicated public servant focused on gender, children, social welfare, and rural communications. Consistently advocates for community development and infrastructure delivery in Ketu South.",
  achievements: [
    "Advocated for increased awareness and passage of the Broadcast Bill",
    "Promoted community radios for rural development",
    "Served on the Gender, Children and Social Welfare Committee",
  ],
                  ...
                  >
                    ...
                    <div className="p-6 pb-5 flex-grow flex flex-col">
                      <div className="flex items-start gap-4 mb-5">
                        <div className="w-14 h-14 rounded-[1px] shrink-0 shadow-sm border-2 border-[#006B3C]/10 overflow-hidden bg-gray-100 flex items-center justify-center font-bold text-xl text-[#006B3C]">
                          {mp.image ? (
                            <img src={mp.image} alt={mp.name} className="w-full h-full object-cover" />
                          ) : (
                            mp.initial
                          )}
                        </div>
            ...
            <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
              <div className="lg:col-span-5 relative">
                ...
                <div className="aspect-[4/5] bg-[#004B2B] rounded-[2rem] overflow-hidden flex items-center justify-center relative">
                  <img src={FEATURED_MP.image} alt={FEATURED_MP.name} className="w-full h-full object-cover" />
